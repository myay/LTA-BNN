...
torch::Tensor customconv2d(
  ...
  return customconv2d_cuda(input, weight, output, threshold, popc_acc, nr_xnor_gates, nr_additional_samples, majv_shift, threshold_scaling, popc_acc_activate, threshold_correction);
}
